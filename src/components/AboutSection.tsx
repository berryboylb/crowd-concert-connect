  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-deep-purple via-festival-purple to-deep-purple">
        ...
        <div
          className="absolute top-32 right-20 w-6 h-6 bg-hot-pink/30 rounded-full animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/3 w-3 h-3 bg-electric-green/30 rounded-full animate-float"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-white/80 text-lg">
            Get ready for the biggest youth festival of the year!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-neon-yellow/20 hover:border-neon-yellow/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-white/80 space-y-2">
              <p>
                <strong>Date:</strong>Saturday, November 29, 2025{" "}
              </p>
              <p>
                <strong>Time:</strong> 7 PM
              </p>
              <p>
                <strong>Duration:</strong> Till Dawn
              </p>
            </div>
          </div>
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-neon-yellow/20 hover:border-neon-yellow/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-white/80 space-y-2">
              ...
              <p>
                <strong>Produced by:</strong> HypeVibe Media
              </p>
            </div>
          </div>
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-neon-yellow/20 hover:border-neon-yellow/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-white/80 space-y-2">
              <p>
                <strong>Audience:</strong> Youth & Young Adults
              </p>
              <p>
                <strong>Age Group:</strong> 16-35 Years
              </p>
              <p>
                <strong>Expected:</strong> 500+ Attendees
              </p>
            </div>
          </div>
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-neon-yellow/20 hover:border-neon-yellow/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-white/80 space-y-2">
              <p>
                <strong>Music:</strong> Afrobeats, Hip-Hop, Amapiano
              </p>
              <p>
                <strong>Artists:</strong> Top Nigerian Performers
              </p>
              <p>
                <strong>Activities:</strong> Games, Food, Drinks, Comedy, Dance
              </p>
            </div>
          </div>
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-neon-yellow/20 hover:border-neon-yellow/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-white/80 space-y-2">
              <p>
                <strong>Food Courts:</strong> Local & International
              </p>
              <p>
                <strong>Photo Booths:</strong> Instagram-worthy Spots
              </p>
              <p>
                <strong>Merchandise:</strong> Exclusive Event Merch
              </p>
            </div>
          </div>
        </div>
